...
{
    public partial class frmCopyleftTokenGeneration_iPhone : Form
    {
        ...
        public frmCopyleftTokenGeneration_iPhone()
        {
            InitializeComponent();
            ...
            sQrStr = "spGetTokenDetails_iPhone " + DateTime.Now.Year + ",1,0,0";
        ...
        {
            string sQr = "";
            sQr = "spGetTokenDetails_iPhone " + DateTime.Now.Year + ",1,0,0";
        ...
        private void cmbClientName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                sQr = sQr + " where isDam=1 and AMPlayerTokens.clientId=" + Convert.ToInt32(cmbClientName.SelectedValue)+ " and PlayerType='iPhone' ";
                ...
                if (dsTotalToken.Tables[0].Rows[0][0].ToString() != "0")
                {
                    ...
                    if (SaveMode == "New")
                    {
                        ...
                        sQr = sQr + " where PlayerType='iPhone' and  AMPlayerTokens.isDam=1 and AMPlayerTokens.ClientID=" + Convert.ToInt32(cmbClientName.SelectedValue) + " order by AMPlayerTokens.UserId desc ";
        ...
        private void AdminMail()
        {
            ...
            body += "\n";
            body += "This is to you inform that new client is registred on iPhone copyleft player and credential are: \n";
...
//            body += "The Manage your Media Team \n";
        ...
        private void cmbSearchClientName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(cmbSearchClientName.SelectedValue) > 0)
            {
                ...
                sQr = sQr + " where PlayerType='iPhone'and  AMPlayerTokens.clientId=" + Convert.ToInt32(cmbSearchClientName.SelectedValue) + "  and isnull(Users.MusicType,'') <>'Copyright' ";
        ...
        private void txtSearchUserName_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (txtSearchUserName.Text.Length >= 1)
                {
                    ...
                    sQr = sQr + " inner join Users on AMPlayerTokens.UserId= Users.UserID ";
                    sQr = sQr + " inner join DfClients on AMPlayerTokens.ClientId= DfClients.DfClientId";
                    sQr = sQr + " where PlayerType='iPhone' and  Users.UserName like '%" + txtSearchUserName.Text + "%'  and isnull(Users.MusicType,'') <>'Copyright' ";
                    sQr = sQr + " and AMPlayerTokens.IsDam=1 and DfClients.IsDealer=0 order by Users.UserID desc  ";
                    FillTokenGenerationData(sQr);
                }
                else
