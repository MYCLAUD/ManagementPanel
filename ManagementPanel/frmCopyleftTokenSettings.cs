...
{
    public partial class frmCopyleftTokenSettings : Form
    {
        gblClass objMainClass = new gblClass();
        DateTimePicker dtpOrder;
        public frmCopyleftTokenSettings()
        {
            InitializeComponent();
        ...
        private void FillClient()
        {
            ...
            str = str + "  and Users.Playertype='Desktop' order by DFClients.DFClientID desc ";
        ...
        private void cmbClientName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            sQr = sQr + " and PlayerType='Desktop'and AMPlayerTokens.IsDam=1  order by Users.UserID desc  ";
        ...
        private void InitilizeAccountSettingsGrid()
        {
            ...
            Sanjivani.HeaderText = "Store";
            Sanjivani.DataPropertyName = "Store";
            dgAccountSettings.Columns.Add(Sanjivani);
            Sanjivani.Width = 60;
            if (cmbPlayerVersion.Text != "Normal")
            {
        ...
        private void SaveUserToken()
        {
            for (int i = 0; i <= dgAccountSettings.Rows.Count - 1; i++)
            {
                ...
                cmd.Parameters["@IsStore"].Value = Convert.ToInt32(dgAccountSettings.Rows[i].Cells[4].Value);
