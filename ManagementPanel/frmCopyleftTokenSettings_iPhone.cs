...
{
    public partial class frmCopyleftTokenSettings_iPhone : Form
    {
        gblClass objMainClass = new gblClass();
        DateTimePicker dtpOrder;
        public frmCopyleftTokenSettings_iPhone()
        {
            InitializeComponent();
        ...
        private void FillClient()
        {
            ...
            str = str + "  and Users.Playertype='iPhone' order by DFClients.DFClientID desc ";
        ...
        private void cmbClientName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            sQr = sQr + " and PlayerType='iPhone'and AMPlayerTokens.IsDam=1  order by Users.UserID desc  ";
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            dtpOrder.Visible = false;
            string sQr = "";
            sQr = " spUserTokenSettingsCopyleft 'iPhone' , " + Convert.ToInt32(cmbUserName.SelectedValue);
