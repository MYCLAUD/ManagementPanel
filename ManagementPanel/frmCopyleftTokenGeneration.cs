...
{
    public partial class frmCopyleftTokenGeneration : Form
    {
        ...
        public frmCopyleftTokenGeneration()
        {
            InitializeComponent();
        ...
        private void SaveTokenGeneration(Int32 Return_UserId)
        {
            ...
            for (int i = 1; i <= TotalToken; i++)
            {
                ...
                cmd.Parameters["@IsStore"].Value = Convert.ToByte(rdoStore.Checked);
        ...
        private Boolean SubmitValidation()
        {
            ...
            if ((cmbPlayerVersion.Text != "Normal") && (cmbPlayerVersion.Text != ""))
            {
                if ((rdoStore.Checked == false) && (rdoStream.Checked == false))
                {
                    MessageBox.Show("Select a type !! Stream or Store Forward!!", "Management Panel");
                    return false;
                }
            }
            return true;
        ...
        private void cmbClientName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            sQr = sQr + " where isDam=1 and AMPlayerTokens.clientId=" + Convert.ToInt32(cmbClientName.SelectedValue) + " and PlayerType='Desktop' ";
            ...
            if (dsTotalToken.Tables[0].Rows[0][0].ToString() != "0")
            {
                ...
                if (SaveMode == "New")
                {
                    ...
                    sQr = sQr + " where PlayerType='Desktop'and AMPlayerTokens.isDam=1 and AMPlayerTokens.ClientID=" + Convert.ToInt32(cmbClientName.SelectedValue) + " order by AMPlayerTokens.UserId desc ";
        ...
        private void SendEmailUser()
        {
            try
            {
                ...
                body += "\n";
                body += "This email contains all the information that is required for you to install your Copyleft Music Player. \n";
                ...
                {
                    body += "Manageyourclaudio setup for Windows 7,8 or 10: \n";
                    body += "http://manageyourclaudio.eu/manageyourclaudioSetup/Copyleft/publish.htm \n";
                    body += "Manageyourclaudio setup for Window XP only: \n";
                    body += "http://manageyourclaudio.eu/manageyourclaudioSetup/WinXp/Copyleft/publish.htm \n";
                }
                if (UserPlayerVersion == "NativeCL")
                {
                    body += "Manageyourclaudio setup for Windows 7,8 or 10: \n";
                    body += "http://manageyourclaudio.eu/manageyourclaudioSetup/Copyleft/NativeCL/publish.htm \n";
                    body += "Manageyourclaudio setup for Window XP only: \n";
                    body += "http://manageyourclaudio.eu/manageyourclaudioSetup/WinXp/Copyleft/NativeCL/publish.htm \n";
                }
                if (UserPlayerVersion == "Total")
                {
                    body += "Manageyourclaudio setup for Windows 7,8 or 10: \n";
        ...
        private void AdminMail()
        {
            try
            {
              ...
              //var toAddress = "talwinder.parastechnologies@gmail.com";
                ...
                body += "\n";
                body += "This is to inform you that a new client is registred on the copyleft player and his credentials are: \n";
                ...
                if (UserPlayerVersion == "Normal")
                {
                    body += "Manageyourclaudio setup for Windows 7,8 or 10: \n";
                    body += "http://manageyourclaudio.eu/manageyourclaudioSetup/Copyleft/publish.htm \n";
                    body += "Manageyourclaudio setup for Windows XP only: \n";
                    body += "http://manageyourclaudio.eu/manageyourclaudioSetup/WinXp/Copyleft/publish.htm \n";
                }
                if (UserPlayerVersion == "NativeCL")
                {
        ...
        private void dgTokenGeneration_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 7)
            {
                ...
                sQr = sQr + " DateTokenExpire,NumberofTitles, PlayerType,Street, Cityname, TeamviewerId , TvPassword ,Users.Vatnumber,Users.Location ,users.Playerversion, AMPlayerTokens.ServiceId, isnull(AMPlayerTokens.IsStore,0) as IsStore, AMPlayerTokens.IsStream";
                ...
                if (dtModify.Rows.Count > 0)
                {
                    ...
                    if ((cmbPlayerVersion.Text != "Normal") && (cmbPlayerVersion.Text != ""))
                    {
                        rdoStore.Checked = Convert.ToBoolean(dtModify.Rows[0]["IsStore"]);
                        rdoStream.Checked = Convert.ToBoolean(dtModify.Rows[0]["IsStream"]);
                    }
                    else
                    {
                        rdoStore.Checked = false;
                        rdoStream.Checked = false;
                    }
        ...
        private void cmbSearchClientName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(cmbSearchClientName.SelectedValue) > 0)
            {
                ...
                sQr = sQr + " and PlayerType='Desktop' and AMPlayerTokens.IsDam=1  and DfClients.IsDealer=0 order by Users.UserID desc  ";
                FillTokenGenerationData(sQr);
            }
            else
            {
        ...
        private void cmbSearchPlayerVersion_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbSearchPlayerVersion.Text != "")
            {
                ...
                sQr = sQr + " inner join Users on AMPlayerTokens.UserId= Users.UserID ";
                sQr = sQr + " inner join DfClients on AMPlayerTokens.ClientId= DfClients.DfClientId";
                sQr = sQr + " where PlayerType='Desktop' and Playerversion='" + cmbSearchPlayerVersion.Text + "'  and isnull(Users.MusicType,'') <>'Copyright'";
