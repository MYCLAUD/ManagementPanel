...
{
    public partial class frmAsianTokenGeneration : Form
    {
        ...
        public frmAsianTokenGeneration()
        {
            InitializeComponent();
            ...
            sQrStr = "spGetTokenDetails " + DateTime.Now.Year + ",0,0,0,1";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            isAsian = 1;
            AsianDateExpiry = dtpDamExpiryDate.Value;


            UserNoOfTitles = cmbNoTitles.Text;
            UserPlayerType = cmbPlayerVersion.Text;
        ...
        private void SaveTokenUser()
        {
            ...
            cmd.Parameters["@PlayerType"].Value = cmbPlayerVersion.Text;
            ...
            cmd.Parameters["@MusicType"].Value = "Asian";
        ...
        private void SaveTokenGeneration(Int32 Return_UserId)
        {
            ...
            for (int i = 1; i <= TotalToken; i++)
            {
                ...
                cmd.Parameters["@isAsian"].Value = "1";

                cmd.Parameters.Add(new SqlParameter("@AsianExpirydate", SqlDbType.DateTime));
                cmd.Parameters["@AsianExpirydate"].Value = dtpDamExpiryDate.Value;
        ...
        {
            string sQr = "";
           // sQr = "spGetTokenDetails " + DateTime.Now.Year + ",1,0,0";
            sQr = "spGetTokenDetails " + DateTime.Now.Year + ",0,0,0,1";
            FillClient();
            dtpDamExpiryDate.Value = DateTime.Now.Date;
        ...
        private Boolean SubmitValidation()
        {
            ...
            {
                MessageBox.Show("Please select no of titles", "Management Panel");
                cmbNoTitles.Focus();
                return false;
            }
            else if (cmbPlayerVersion.Text == "")
            {
                MessageBox.Show("Please select a player type", "Management Panel");
            ...
            if (LastTotalTokens < Convert.ToInt32(txtNoToken.Text))
            {
                if (chkAsian.Checked == false)
                {
                    MessageBox.Show("Please select atleast one subscription", "Management Panel");
                    chkAsian.Focus();
                    return false;
                }
            }
            ...
            {
                MessageBox.Show("Please Select a Country from the list", "Management Panel");
                cmbCountryName.Focus();
                return false;
            }
            if (Convert.ToInt32(cmbStateName.SelectedValue) == 0)
            {
                MessageBox.Show("Please select a state", "Management Panel");
                cmbStateName.Focus();
                return false;
            }
            if (Convert.ToInt32(cmbCityName.SelectedValue) == 0)
            {
                MessageBox.Show("Please select a city", "Management Panel");
                cmbCityName.Focus();
                return false;
            }
            return true;
        ...
        private void cmbClientName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            sQr = sQr + " where isAsian=1 and AMPlayerTokens.clientId=" + Convert.ToInt32(cmbClientName.SelectedValue) + " and PlayerType='Desktop' ";
            dsTotalToken = objMainClass.fnFillDataSet(sQr);

            if (dsTotalToken.Tables[0].Rows[0][0].ToString() != "0")
            {
                lblTotalTokens.Text = "Total no of tokens(Asian) : " + dsTotalToken.Tables[0].Rows[0][0].ToString();
                ...
                if (SaveMode == "New")
                {
                    ...
                    sQr = sQr + " where PlayerType='Desktop'and AMPlayerTokens.isAsian=1 and AMPlayerTokens.ClientID=" + Convert.ToInt32(cmbClientName.SelectedValue) + " order by AMPlayerTokens.UserId desc ";
                    ...
                    if (dtGetData.Rows.Count > 0)
                    {
                        ...
                        txtLocationName.Text = "";
                        txtNoToken.Text = "1";
                        cmbPlayerVersion.Text = dtGetData.Rows[0]["PlayerType"].ToString();
        ...
        private void SendEmailUser()
        {
            try
            {
                ...
                body += "\n";
                body += "This email contains all the information that is required for you to install your Asian Music Player. \n";
                body += "The installation is required to be done in Chrome. \n";
                body += "1. Click on the link and follow the instructions: \n";
                if (isAsian == 1)
                {
                    body += "Asian player setup for Windows 7,8 or 10: \n";
                    body += "http://manageyourclaudio.eu/manageyourclaudioSetup/Asian/publish.htm \n";
                    body += "Asian player setup for windowXp only:- \n";
                    body += "http://manageyourclaudio.eu/manageyourclaudioSetup/WinXp/Asian/publish.htm \n";
                ...
                body += "Your asian subscription expiry date: " + AsianDateExpiry + " \n";
        ...
        private void SendEmailMainClientData()
        {
            try
            {
                ...
                if (isAsian == 1)
                {
                    body += "Your Copyleft subscription expiry date: " + AsianDateExpiry + " \n";
                }
        ...
        private void AdminMail()
        {
            try
            {
                ...
                body += "\n";
                body += "This is to you inform that new client is registred on the asian player and his credential are: \n";
                ...
                body += "The Installation dealer code: MyClaud000 \n";
        ...
        private void dgTokenGeneration_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 7)
            {
                ...
                if (dtModify.Rows.Count > 0)
                {
                    ...
                    cmbPlayerVersion.Text = dtModify.Rows[0]["PlayerType"].ToString();
        ...
        private void cmbSearchClientName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(cmbSearchClientName.SelectedValue) > 0)
            {
                ...
                sQr = sQr + " where AMPlayerTokens.clientId=" + Convert.ToInt32(cmbSearchClientName.SelectedValue) + "  and isnull(Users.MusicType,'') <>'Copyright' ";
                sQr = sQr + " and PlayerType='Desktop'and AMPlayerTokens.isAsian=1  and DfClients.IsDealer=0 order by Users.UserID desc  ";
                FillTokenGenerationData(sQr);
            }
            else
            {
        ...
        private void txtSearchUserName_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    MessageBox.Show("Enter minimum 2 characters for a search function.", "Management Panel");
                    return;
                }
                if (txtSearchUserName.Text.Length >= 1)
                {
                    ...
                    sQr = sQr + " inner join Users on AMPlayerTokens.UserId= Users.UserID ";
                    sQr = sQr + " inner join DfClients on AMPlayerTokens.ClientId= DfClients.DfClientId";
                    sQr = sQr + " where Users.UserName like '%" + txtSearchUserName.Text + "%'  and isnull(Users.MusicType,'') <>'Copyright' ";
                    sQr = sQr + " and PlayerType='Desktop'and AMPlayerTokens.isAsian=1 and DfClients.IsDealer=0 order by Users.UserID desc  ";
                    FillTokenGenerationData(sQr);
                }
                else
        ...
        private void cmbSearchPlayerType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbSearchPlayerType.Text != "")
            {
                ...
                sQr = sQr + "  and AMPlayerTokens.isAsian=1 and DfClients.IsDealer=0 and DfClients.IsDealerClient is null  and DfClients.IsDealerClient is null order by Users.UserID desc  ";
                FillTokenGenerationData(sQr);
        ...
        private void btnStateNew_Click(object sender, EventArgs e)
        {
            if (Convert.ToInt32(cmbCountryName.SelectedValue) == 0)
            {
                MessageBox.Show("Please Select a Country from the list name", "Management Panel");
                cmbCountryName.Focus();
                return;
            }
            txtName.Text = "";
        ...
        private void btnCityNew_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(cmbStateName.SelectedValue) == 0)
            {
                MessageBox.Show("Please select a state name", "Management Panel");
                cmbStateName.Focus();
                return;
            }
            txtName.Text = "";
